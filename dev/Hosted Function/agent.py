...
# TODO: Create python function implementations for non-hosted functions and add them to tools (https://python.langchain.com/docs/concepts/tools/): get_distance_between_locations
